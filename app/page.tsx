	...
	return (
		<div onMouseMove={(event) => updateShadowPosition(event)}>
			...
			>
				...
				<div className="text-9xl flex min-h-screen items-center justify-center overflow-y-hidden overflow-x-hidden col-span-2 bottom-10">
					<div className="font-lexend font-bold leading-snug not-visible translate-x-[50%] blur">
						<h1>Learning</h1>
						<h1>Building</h1>
						<h1>Growing</h1>
					</div>
					<div className="flex items-center justify-center w-[650px] h-[650px] max-[1280px]:hidden">
						<div className="absolute rounded-full background-blur not-visible translate-x-[40%] blur"></div>{" "}
			...
			<div className="grid gap-[40rem] pb-24 mt-[20rem]">
				...
				<div className="w-[60%] mx-auto overflow-x-hidden" id="skills">
					<h1
